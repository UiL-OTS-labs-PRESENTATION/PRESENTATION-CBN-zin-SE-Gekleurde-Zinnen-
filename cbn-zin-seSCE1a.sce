...
pcl_file = "cbn-zin-sePCL1a.pcl"; 					# pcl file name geven
scenario = "cbn-zin-seSCE1a.sce"; 						# for log-file
...
active_buttons = 5;									# 5 buttons active
...
trial {													# trial define
	...
	picture { 											# het object is een picture
		text { caption = "Welkom bij het experiment ‘Gekleurde Zinnen’. 

Je krijgt zo meteen woord-voor-woord zinnen te lezen 
op het computerscherm. Het laatste woord van elke zin 
kan in het rood, geel, groen of blauw op het scherm
verschijnen. Als je een gekleurd woord ziet, gaat het
erom dat je zo snel mogelijk de kleur van het woord
benoemt via een druk op een toets. Het gaat in dit experiment 
dus niet om de betekenis van het gekleurde woord, maar slechts 
om de kleur. Telkens als je de kleur hebt benoemd, 
krijg je de volgende zin te zien. 
...
Als dit NIET jouw naam is, 
waarschuw dan de proefleider.

Als dit wel jouw naam is, 
druk dan op enter om verder te gaan.

Druk nu op enter om jouw naam te zien.";											# met de text 'oefensessie'
		font_size = 35;}; 
		x = 0; y = 0;};								# in het midden van het scherm														
	response_active = true;  						# responsen komen door
...
Tijdens de oefensessie gaan de zinnen over Sanne
en krijg je feedback. Probeer zo snel mogelijk 
de kleuren van elke toets te leren.
...
op het kaartje terug. 

N.B. Sommige zinnen zijn beledigend, 
als je het erg onprettig vindt om deze beledigingen te lezen, 
dan kun je altijd besluiten om te stoppen.

Leg nu je vingers klaar op de toetsen. Start de 
oefensessie door op enter te drukken. Succes!"; 											# met de text 'oefensessie'
		font_size = 35;};
		x = 0; y = 0;};								# in het midden van het scherm														
